...
it shows how to develop USB Device Human Interface "HID" keyboard based application.

The application is designed to emulate a USB HID keyboard device, the code provides all required device descriptors framework
and associated class descriptor report to build a compliant USB HID keyboard device.
...
RTOS, ThreadX, USBXDevice, USB_OTG, Full Speed, HID, keyboard.
